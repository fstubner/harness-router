...
import { syntheticServiceId, v3ToRouterConfig } from "../../src/v3/adapter.js";
...
describe("v3ToRouterConfig — single-route shape", () => {
...
describe("v3ToRouterConfig — multi-harness subscription", () => {
...
describe("v3ToRouterConfig — generic_cli + cli_model_override", () => {
